  ...
  return (
    <div className="fixed inset-x-0 bottom-0 top-16 z-[200] flex items-center justify-center bg-black/70 px-4 py-6 backdrop-blur-sm">
      <div
        ...
        className="relative flex max-h-full w-full max-w-4xl flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#1c1f26] shadow-2xl"
      >
        ...
        <div className="flex-1 space-y-5 overflow-y-auto px-5 py-5">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl bg-white/5 p-4">
              ...
              <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-light-400">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-3 text-center">
              ...
              <p className="text-[11px] text-light-500">Comments</p>
            </div>
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-3 text-center">
              <Eye className="mx-auto mb-1 size-4 text-light-400" />
              <p className="text-base font-semibold text-white">
                {solution.viewCount}
              </p>
              <p className="text-[11px] text-light-500">Views</p>
            </div>
          </div>
