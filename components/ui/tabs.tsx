...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "inline-flex h-11 items-center justify-start gap-1 rounded-2xl border border-white/10 bg-white/[0.04] p-1 text-light-100",
        className,
      )}
      {...props}
    />
